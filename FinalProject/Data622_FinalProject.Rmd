...
author: "Adam Gersowitz, Amit Kapoor, Kevin Potter, Zachary Palmore, Paul Perez"
date: "11/26/2021"
output:
  pdf_document:
...
var1 <- round(conf.mat.decisiontree$overall[1], 4)
var2 <- (round(conf.mat.decisiontree$overall[1], 2)*100)
```


Our decision Tree model accuracy comes out as `r var1` or roughly `r var2`%. There is room for improvement in this model's sensitivity among other variables. We try to improve this with the random forest model. 
