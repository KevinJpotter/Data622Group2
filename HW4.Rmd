...
In this unsupervised learning method we attempt to identify clear orders of factor and their respective levels across the dataset. To do this we isolate those factors, center and scale the values, and
...
We can see that model Gradient Boosted model has the best accuracy at 77.5% when applied to the test dataset. We could improve these models through more through feature selection via PCA or other methods and by focusing on feature engineering by using what was identified by these methods.
